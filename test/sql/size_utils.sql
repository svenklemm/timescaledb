...
SELECT count(*) FROM approx_count_dp_nested;
SELECT count(*) FROM approx_count_dp_nested_0;
SELECT count(*) FROM approx_count_dp_nested_0_0;
SELECT count(*) FROM approx_count_dp_nested_0_1;
SELECT count(*) FROM approx_count_dp_nested_1;
SELECT count(*) FROM approx_count_dp_nested_1_0;
SELECT count(*) FROM approx_count_dp_nested_1_1;

SELECT * FROM approximate_row_count('approx_count_dp_nested');
ANALYZE approx_count_dp_nested;
SELECT * FROM approximate_row_count('approx_count_dp_nested');
SELECT * FROM approximate_row_count('approx_count_dp_nested_0');
SELECT * FROM approximate_row_count('approx_count_dp_nested_0_0');
SELECT * FROM approximate_row_count('approx_count_dp_nested_0_1');
SELECT * FROM approximate_row_count('approx_count_dp_nested_1');
SELECT * FROM approximate_row_count('approx_count_dp_nested_1_0');
SELECT * FROM approximate_row_count('approx_count_dp_nested_1_1');
